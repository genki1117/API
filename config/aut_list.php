...
return [
    ...
    */
    ...
    //TODO システム利用ユーザ権限の「テンプレート登録権限」に該当する項目がユーザ権限マスタに見当たらない
    ...
    //TODO 電子契約ユーザ・権限一覧.xlsxの、どのCSVダウンロードに該当するのか不明　仮で[書類一覧] - [CSVダウンロード] で設定
    ...
    //TODO 電子契約ユーザ・権限一覧.xlsxのどれに該当するのか不明　一旦、true固定(権限OK)
    '/documents/up-word' => [
        'admin_role' => true,								    // 管理者権限
        'template_set_role' => true,						    // テンプレート作成・編集権限
        'workflow_set_role' => true,						    // 承認経路作成権限
        ...
        'use_cert_role' => true,							    // 当事者型での署名権限
        'reader_role' => true,					                // 閲覧者
        'applicant_role' => true,							    // 申込者
        'system_administrator_role' => true,                    // システム管理者
        'guest_user_role' => true,						        // ゲスト
    ],
    ...
    //TODO 電子契約ユーザ・権限一覧.xlsxの、どれに該当するのか不明　仮で[一括検証範囲指定] - [画面初期表示]にしておく
    ...
    //TODO 電子契約ユーザ・権限一覧.xlsxの、どれに該当するのか不明　仮で一括検証と同じにしておく
    ...
    //TODO 電子契約ユーザ・権限一覧.xlsxの、どのCSVダウンロードに該当するのか不明　仮で[書類検索結果] - [CSVダウンロード] で設定
