...
class DocumentGetListRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'condition.amount.from.after_or_equal' => '開始金額には、終了金額より未来金額を指定してください。',
            ...
            'condition.doc_info.from.string' => '摘要には文字のみ入力してください。',
            'condition.doc_info.to.string' => '摘要には文字のみ入力してください。',
            ...
            'sort.column_name.in' => 'ソート項目には項目を指定してください。',
            'sort.sort_type.string' => '並び順には文字のみ入力してください。',
            'sort.sort_type.in' => '並び順にはascの値もしくはdescの値を指定してください。',
