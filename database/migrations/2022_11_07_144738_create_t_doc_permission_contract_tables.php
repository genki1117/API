...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('t_doc_permission_contract', function (Blueprint $table) {
            $sql = "CREATE TABLE t_doc_permission_contract (
    ...
    {
        Schema::dropIfExists('t_doc_permission_contract');
    }
};
