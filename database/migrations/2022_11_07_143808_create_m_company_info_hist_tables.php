...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('m_company_info_hist', function (Blueprint $table) {
            $sql = "CREATE TABLE m_company_info_hist (
				...
				, constraint idx_m_company_info primary key (history_id,company_id)
			) comment '会社情報マスタ履歴' ";			
    ...
    {
        Schema::dropIfExists('m_company_info_hist');
    }
};
