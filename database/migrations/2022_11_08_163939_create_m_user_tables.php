    ...
    public function up()
    {
		Schema::table('m_user', function (Blueprint $table) {
            $sql = "CREATE TABLE m_user (
				...
				,language varchar(2) DEFAULT 'JA'  comment 'Language'
				,profile_image longblob   comment 'Profile Image'
				,company_counter_party_id varchar(255)   comment 'Company Counter Party ID'
				...
				, constraint idx_m_user primary key (user_id,company_id)
			) comment 'ユーザマスタ' ";
