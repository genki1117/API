...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('t_doc_permission_internal', function (Blueprint $table) {
            $sql = "CREATE TABLE t_doc_permission_internal (
    ...
    {
        Schema::dropIfExists('t_doc_permission_internal');
    }
};
