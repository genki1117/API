...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('m_compnay_counter_party_hist', function (Blueprint $table) {
            $sql = "CREATE TABLE m_company_counter_party_hist (
                history_id bigint unsigned AUTO_INCREMENT not null comment 'History ID'
                ,company_id bigint  not null comment 'Company ID'
                ,counter_party_id bigint  not null comment 'Counter Party ID'
                ...
                , constraint idx_m_company_counter_party primary key (history_id,company_id,counter_party_id)
            ) comment '相手先マスタ履歴' ";            
    ...
    {
        Schema::dropIfExists('m_compnay_counter_party_hist');
    }
};
