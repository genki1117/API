...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('t_document_deal', function (Blueprint $table) {
            $sql = "CREATE TABLE t_document_deal (
				...
				,download_date date   comment 'Download Date'
    ...
    {
        Schema::dropIfExists('t_document_deal');
    }
};
